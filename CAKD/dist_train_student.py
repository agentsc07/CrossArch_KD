"""
CIFAR-10 Adapted ResNet50 Baseline Training Script
Modified from: dist_train_student.py (original ImageNet version)
...
- Changed epochs from 90 → 30 for faster training
- Increased batch size from 32 → 64 for single GPU
- Reduced workers from 16 → 4
- Updated output directory to ./results/cifar10_baseline
- Simplified data loading (no cache paths, no distributed samplers)

For full changelog, see: ../CHANGELOG.md

Run: python dist_train_student.py --epochs 30 --batch-size 64 --device cuda
Or: bash experiments/run_baseline_cifar10.sh
"""
...
def get_args_parser(add_help=True):
    ...
    parser.add_argument("--output-dir", default="./results/cifar10_baseline", type=str, help="path to save outputs")
